...
Scenario: Register time to a project activity for the first time on the given date
    ...
    And the start time of the activity with name "Activity Name" of project with project number "22001" is year 2022 and week 20
    And the end time of the activity with name "Activity Name" of project with project number "22001" is year 2022 and week 40
...
Scenario: The user tries to register negative hours
    ...
    And the total time of project with project number "22001" is set to 19 hours
    And the total time of activity with name "Activity Name" of project with project number "22001" is set to 10 hours
...
Scenario: The user tries to register more than 24 hours
    ...
    And the total hours registered to the project with project number "22001" is 19 hours
    And the total hours registered to the activity with name "Activity Name" of the project with project number "22001" is 10 hours
    When the current user registers 25.5 hours for day 1 of week 23 of year 2022 to the activity with name "Activity Name" of project with project number "22001"
...
Scenario: Register time to a project activity outside the time horizon of the project
    ...
    And the total hours registered to the project with project number "22001" is 19 hours
    And the total hours registered to the activity with name "Activity Name" of the project with project number "22001" is 10 hours
    And the start time of the activity with name "Activity Name" of project with project number "22001" is year 2022 and week 30
    And the end time of the activity with name "Activity Name" of project with project number "22001" is year 2022 and week 40
    When the current user registers 5.5 hours for day 1 of week 23 of year 2022 to the activity with name "Activity Name" of project with project number "22001"
