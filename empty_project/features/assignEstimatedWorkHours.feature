...
Scenario: A project leader sets the estimated number of work hours for an activity
	...
	When the user with initials xxxx sets the number of work hours for activity a of project yyxxx
		to k hours
...
Scenario: The user is not the project leader
	...
	When the user with initials xxxx sets the number of work hours for activity a of project yyxxx
		to k hours
	Then the system provides an error message that the user is not the project leader of project
		yyxxx
