...
Scenario: Create activity
  ...
  Then the activity with name "Activity Name" is added to the list of activities for the project with project number "22001"
...
Scenario: Activity already exists
  ...
  And the list of activities for the project with project number "22001" does not contain the activity with name "Activity Name" twice
...
Scenario: User is not the project leader of project
  ...
  And the activity with name "Activity Name" is not added to the list of activities for the project with project number "22001"
