...
Scenario: A project leader accesses a project report
  ...
  And the estimated number of work hours needed for the project with project number "22001" is 20.5 hours
  And the estimated number of work hours needed for the activity with name "Activity Name" of project with project number "22001" is 20.5 hours
...
Scenario: A non project leader accesses a project report
  ...
  And the project report of the project with project number "22001" is not generated
