...
Scenario: Add developer to activity
  ...
  And the developer with initials "mani" is not currently assigned to the activity with name "Activity Name" of project with project number "22001"
  When the current user assigns the developer with initials "mani" to activity with name "Activity Name" of project with project number "22001"
...
Scenario: Developer is already assigned to the activity
  ...
  And a developer with initials "mani" exists in the company
  And the developer with initials "mani" is already assigned to the project with project number "22001"
  And the developer with initials "mani" is already assigned to the activity with name "Activity Name" of project with project number "22001"
  When the current user assigns the developer with initials "mani" to activity with name "Activity Name" of project with project number "22001"
...
Scenario: Developer does not exist in the system
  ...
  When the current user assigns the developer with initials "amag" to activity with name "Activity Name" of project with project number "22001"
  Then the system provides an error message "No developer with the given initials exists in the system"
  And the developer with initials "amag" is not assigned to the activity with name "Activity Name" of project with project number "22001"
