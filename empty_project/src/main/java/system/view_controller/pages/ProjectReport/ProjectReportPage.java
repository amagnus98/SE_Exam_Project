...
public class ProjectReportPage {
    ...
    public JPanel draw() {
        ...
        JLabel estimatedHoursLabel = new JLabel("" + projectReport.getEstimatedHoursOnProject());
        ...
        JLabel totalHoursLabel = new JLabel("" + projectReport.getTotalHoursWorkedOnProject());
        ...
        for (int i = 0; i < activities.size(); i++) {
            ...
            JLabel activityTotalLabel = new JLabel("Total: " + activity.getTotalHoursWorked());
