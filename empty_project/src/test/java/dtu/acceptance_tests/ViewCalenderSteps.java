...
public class ViewCalenderSteps {
    ...
    @Then("the current user can see {double} hours registered for the activity with name {string} of project with project number {string}")
    public void the_current_user_can_see_hours_registered_for_the_activity_with_name_of_project_with_project_number(double hours, String activityName, String projectNumber) {
