...
public class WhiteBoxtestRegisterHoursToActivity{
    ...
    public void testSetTimeHorizonOfProjectD() throws OperationNotAllowedException{
      ...
      double currentlyRegisteredHoursProject = app.getProject(projectNumber).getTotalHoursWorked();
      double currentlyRegisteredHoursActivity =  app.getProject(projectNumber).getActivity(activityName).getTotalHoursWorked();
      ...
      assertTrue(app.getProject(projectNumber).getTotalHoursWorked() == (currentlyRegisteredHoursProject+7.5));
      assertTrue(app.getProject(projectNumber).getActivity(activityName).getTotalHoursWorked() == (currentlyRegisteredHoursActivity+7.5));
    }
