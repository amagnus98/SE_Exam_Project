...
Scenario: Developer does not exist
  ...
  When the current user assigns a developer with initials "amag" as project leader of the project with project number current year plus "001"  
  Then the system provides an error message "No developer with the given initials exists in the system"
  And the developer with initials "amag" is not assigned as project leader of the project with project number current year plus "001"
  And the developer with initials "amag" is not assigned to the project with project number current year plus "001"
