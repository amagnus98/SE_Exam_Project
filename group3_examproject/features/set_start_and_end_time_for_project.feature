...
Scenario: Non-project leader edits the time horizon of a project
  ...
  And the start time of the project with project number current year plus "001" is not updated to year 2022 and week 30
...
Scenario: End time occurs before start time for project
  ...
  And the start time of the project with project number current year plus "001" is not updated to year 2022 and week 30
  And the end time of the project with project number current year plus "001" is not updated to year 2022 and week 25
...
Scenario: The user tries to edit the time horizon for a project that conflicts with the time horizon of its activities
  ...
  And the start time of the activity with name "Activity Name" of project with project number current year plus "001" is year 2022 and week 25
...
Scenario: Format of time horizon for project is invalid
  ...
  And the start time of the project with project number current year plus "001" is not updated to year 2022 and week 0
  And the end time of the project with project number current year plus "001" is not updated to year 2022 and week 30
