...
Scenario: Add developer to activity who is assigned to the project
  ...
  And the developer with initials "mani" has not been requested to the activity with name "Activity Name" of project with project number current year plus "001"
...
Scenario: Developer has already been requested to the activity
  Given the current user is a developer with initials "amag"
  And a project with project number current year plus "001" exists in the system
  And the developer with initials "amag" is the project leader of the project with project number current year plus "001"
  And the project with project number current year plus "001" contains an activity with name "Activity Name"
  And a developer with initials "mani" exists in the company
  And the developer with initials "mani" has already been requested to the activity with name "Activity Name" of project with project number current year plus "001"
  And the developer with initials "mani" is not currently assigned to the activity with name "Activity Name" of project with project number current year plus "001"
  When the current user assigns the developer with initials "mani" to activity with name "Activity Name" of project with project number current year plus "001"
...
Scenario: Developer does not exist in the system
  ...
  When the current user assigns the developer with initials "bond" to activity with name "Activity Name" of project with project number current year plus "001"
  Then the system provides an error message "No developer with the given initials exists in the system"
  And the developer with initials "bond" is not assigned to the activity with name "Activity Name" of project with project number current year plus "001"
